      ...
      <section className="bg-slate-50 py-1">
        ...
        <div className="flex flex-col items-center justify-center mt-10 gap-3 mb-10 md:flex-row md:flex-wrap md:justify-center">
          <CardOne
            ...
            header="Data Science"
            body="We are excited to announce the launch of our dedicated community focused on all things Data science. Whether you're a Data science expert or just beginning your Data science, this community is the perfect platform to explore, learn, and connect , colloborate and learn together. 💻💡. 💻💡."
          ...
          <CardOne
            ...
            body="We are excited to announce the launch of our dedicated community focused on all things Cloud Computing. Whether you're a Cloud expert or just beginning your Cloud journey, this community is the perfect platform to explore, learn, and connect , colloborate and learn together. 💻💡. 💻💡 ."
            link="https://chat.whatsapp.com/FKDHUWJPjEyCoG0VLKRbEZ"
          />
          <CardOne
            img="https://img.freepik.com/free-photo/html-css-collage-concept-with-hacker_23-2150061984.jpg?size=626&ext=jpg&ga=GA1.1.570712340.1707328262&semt=ais"
            header="Cyber security"
            body="We are excited to announce the launch of our dedicated community focused on all things Cyber Security. Whether you're a cyber security expert or just beginning your cyber security journey, this community is the perfect platform to explore, learn, and connect , colloborate and learn together. 💻💡. 💻💡 ."
          ...
          <CardOne
            ...
            header="UI/Ux"
            body="We are excited to announce the launch of our dedicated community focused on all things UI/UX. Whether you're a seasoned coder or just beginning your UI/UX journey, this community is the perfect platform to explore, learn, and excel in the world of design and prototyping. 💻💡 ."
          ...
          <CardOne
            ...
            header="Android, flutter & IOS"
            body="We are excited to announce the launch of our dedicated community focused on all things app development. Whether you're a seasoned coder or just beginning your coding journey, this community is the perfect platform to explore, learn, and excel in the world of app development. 💻💡 ."
        ...
        <div className="mt-20 mb=20">
          ...
          <div className="flex flex-col items-center justify-center mt-10 gap-4 mb-10 md:flex-row md:flex-wrap md:justify-center">
            <CardOne
              ...
              header="Bangalore Community"
              body="We are thrilled to announce the launch of our brand new WhatsApp community dedicated to all banglore software enginner's 🤝."
            ...
            <CardOne
              ...
              header="Hyderabad"
              body="We are thrilled to announce the launch of our brand new WhatsApp community dedicated to all hyderbad software enginner's 🤝."
              link="https://chat.whatsapp.com/JoWTazqmBleGTnI4Hgvp87"
            />
            <CardOne
              ...
              header="Pune"
              body="We are thrilled to announce the launch of our brand new WhatsApp community dedicated to all pune software enginner's 🤝."
            ...
            <CardOne
              ...
              header="NCR"
              body="We are thrilled to announce the launch of our brand new WhatsApp community dedicated to all NCR software enginner's 🤝."
