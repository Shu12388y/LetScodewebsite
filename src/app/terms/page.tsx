...
function page() {
  return (
    <div>
      <div className="page flex flex-col mt-10 mb-10 justify-center">
        <div className="header">
            <div className="container">
                <p className="title font-bold text-2xl text-center">Terms and Conditions for letcode</p>
            </div>
        </div>
          ...
          <div className="container">
            ...
            >
              ...
              <ul>
                ...
                <li>
                  <p>
                    <strong>Website</strong> refers to letcode, accessible from{" "}
                    <a
                      href="www.letcode.co.in"
