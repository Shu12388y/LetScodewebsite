...
const CardLgrp = ({ img, title, description }:{img:string,title:string,description:string}) => {
  return (
    <div className="bg-gray-100 p-6 rounded-lg mx-auto w-4/4 flex flex-col justify-center items-center">
      <Image height={400} width={400} src={img} alt="coding" className="w-full h-50 object-cover object-center mb-6 rounded-lg" />
