        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 justify-center">
            <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
              <h1 className="text-3xl mb-2 text-center text-black font-bold">Browse Job Category</h1>
              <p className="text-center mt-6 text-gray-600">The Best Engineering Roles at the Best Companies</p>
              <p className="text-center text-gray-600">Premier jobs to grow your skills and progress your career journey</p>
          ...
          <div className="grid grid-cols-3 gap-4">
            {cards.map((card, index) => (
              <JobCard key={index} img={card.img} title={card.title} description={card.description} link={card.link} />
            ))}
          </div>
