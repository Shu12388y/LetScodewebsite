...
const JobCard = ({ img, title, link }:{ img: string, title: string, link: string }) => {
  return (
    <div className="bg-gray-100 p-6 rounded-lg mx-auto w-3/4 flex flex-col justify-center items-center">
      <Image width={500} height={500} src={img} alt="coding" className="w-full h-50 object-cover object-center mb-6 rounded-lg" />
